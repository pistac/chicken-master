...
public class CuztomCharPreviewCamera : MonoBehaviour
{
    protected void Start()
    {
        ...
        // Blocking
        _gui.btnBlockOnce.onClick.AddListener( () => {
            _targetAnimator.SetTrigger( "blockOnce" );
        });
        _gui.btnBlockLoop.onClick.AddListener( () => {
            _targetAnimator.SetTrigger( "blockLoop" );
        });
        #endregion
    }
